...
exports.run = async (bot, message, args) => {
    ...
    if (!args[0]) {
        return message.channel.send("❌  Lütfen geçerli bir STEAMID64 veya özel URL girin");
    }
    ...
    request(UR_L, function(err, resp, body) {
        ...
        if (KD == -1) {
            message.channel.send("❌  Geçersiz, profilinizin gizli olmadığından ve geçerli bir STEAMID64 veya Özel URL girdiğinizden emin olun!");
            return;
        }
